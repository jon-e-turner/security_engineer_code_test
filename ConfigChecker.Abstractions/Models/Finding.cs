...
namespace ConfigChecker.Abstractions.Models
{
    public sealed class Finding : EntityBase
    {
        ...
        private Finding(string reportId, string resourceName, FindingName name, string description, string mitigation,
            FindingSeverity severity, string cweId)
        {
            ReportId = reportId;
        ...
        public static Finding Create(string reportId, string resourceName, FindingName name, string description,
            ...
            string mitigation, FindingSeverity severity, string cweId)
        {
            ...
            {
                exceptions.Add(new ArgumentException("Mitigation recommendataion cannot be empty.",
                    nameof(mitigation)));
            }
