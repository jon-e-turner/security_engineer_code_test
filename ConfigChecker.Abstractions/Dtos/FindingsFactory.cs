...
namespace ConfigChecker.Abstractions.Dtos
{
    public static class FindingsFactory
    {
        ...
        private static string GetFindingDetails(FindingName findingName)
        {
            return findingName switch
            {
                OpenRcePort =>
                    @"Port {0} can be used to remotely administer a host, and should never be exposed to the public.",
