...
namespace ConfigChecker.Services
{
        ...
        ChannelReader<ProcessingRequestDto> reader) : BackgroundService
    {
        ...
        private async ValueTask AnalyzeConfigurationAsync(string reportId, string filePath,
        ...
        private async ValueTask TryPersistToDatastore(string reportId, List<FindingDto> findings,
            CancellationToken cancellation)
        {
            while (!cancellation.IsCancellationRequested)
            {
